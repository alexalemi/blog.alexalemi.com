...
<html lang="en">
  <head>
    ...
    <meta itemprop="name" content="bits.alexalemi.com">
    <meta itemprop="description" content="Alex Alemi's Bits - Short thoughts, links, and finds">
    <meta itemprop="image" content="https://alexalemi.com/images/me_small.jpg">

    <!-- Twitter -->
    <meta name="twitter:card" content="summary">
    <meta name="twitter:title" content="bits.alexalemi.com">
    <meta name="twitter:description" content="Alex Alemi's Bits - Short thoughts, links, and finds">
    ...
    <meta name="og:title" content="bits.alexalemi.com">
    <meta name="og:description" content="Alex Alemi's Bits - Short thoughts, links, and finds">
    <meta name="og:image" content="https://alexalemi.com/images/me_small.jpg">
    <meta name="og:url" content="https://bits.alexalemi.com">
    <meta name="og:site_name" content="bits.alexalemi.com">
...
<body>
    ...
    <header>
        ...
        <nav>
          <a href='https://bits.alexalemi.com' />Bits</a> |
