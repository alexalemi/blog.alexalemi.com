...
If you need a good way to mentally calculate a square root of $p$: take a guess $g$ for the square root, and then compute the average of $p$ and $p/g$.  You can iterate this many times to get as accurate as you desire.<sup><a href="#cook">xxa-cook</a></sup>
